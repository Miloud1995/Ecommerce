                ...
                <div style="max-height: 230px;" data-simplebar="">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <div class="notify-icon">
                            <img src="Admin/assets/images/users/avatar-2.jpg" class="img-fluid rounded-circle"
                                alt="">
                        </div>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <div class="notify-icon">
                            <img src="Admin/assets/images/users/avatar-4.jpg" class="img-fluid rounded-circle"
                                alt="">
                        </div>
